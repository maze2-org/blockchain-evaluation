...
export const alchemyRpcEndpoint = `https://eth-sepolia.g.alchemy.com/v2/${ALCHEMY_GOERLI_KEY}`;
export const alchemyWsRpcEndpoint = `wss://eth-sepolia.g.alchemy.com/v2/${ALCHEMY_GOERLI_KEY}`;
